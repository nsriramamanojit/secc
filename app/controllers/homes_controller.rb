class HomesController < ApplicationController
  ...
  def index
    ...
    @revenue_blocks = RevenueBlock.where(:id => current_user.user_profile.revenue_block_id).paginate(:page =>page, :per_page=>per_page) if has_any_role?(:block_admin,:block_supervisor,:block_incharge)
  end
