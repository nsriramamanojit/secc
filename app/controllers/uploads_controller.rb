...
class UploadsController < ApplicationController
  ...
  def index
    @uploads = Upload.where(:revenue_block_id=>current_user.user_profile.revenue_block_id) if has_role?(:block_admin)
  ...
  def list_revenue_block
    @uploads = Upload.where(:revenue_block_id=>params[:id])
